...
void imprimeInstancia( const vector<Item> &itens, const vector<Mochileiro> &ladroes, const vector<Casa> &cidade, ofstream& saida){
    ...
    for(int i=0; i<ladroes.size(); i++){
        ...
        for(int j=0; j< ladroes[i].mochila.size(); j++){
            ...
            for(int k=0; k< ladroes[i].mochila[j].size(); k++){
                saida<< ladroes[i].mochila[j][k]+1<<"_"<<itens[ ladroes[i].mochila[j][k] ].ondeTo+1 << endl;
...
void mttp(vector<Casa> &cidade, vector<Item> &itens, vector<vector<int>> &distCasas, int i, ofstream& saida){
   ...
   double grr = fObj(ladroes, itens, cidade, distCasas, capacidade);  
    ...
    imprimeInstancia(itens,bestVndIls,cidade,saida);
    ...
    // 	imprimeInstancia(itens,bestGrasp,cidade,saida);
