...
void Greedy3(vector<Casa> &cidade, vector<Item> &itens, vector<Mochileiro> &ladroes, vector<vector<int>> &distCasas){
    ...
    for(int i=0;i<nIteracoes;i++){
        ...
        greedy3(cidadeClone,itens,ladroesClone,distCasas, i*multi+1);
...
void ILS(vector<Casa> &cidade, vector<Item> &itens, vector<Mochileiro> &ladroes, vector<vector<int>> &distCasas, bool reaproveitaSolucao){
    ...
    for(int iter= 0 ; iter<nbiter; iter++){
        ...
        //Chama a VND
        double temp = fObj(ladroes, itens, cidade, distCasas);
        // cout<<"Antes de chamar a VND: "<<temp<<endl;

        VND(cidade,itens,ladroes,distCasas);
        double temp2 = fObj(ladroes, itens, cidade, distCasas);
